...
const ServiceItem = ({service, barbershop}: ServiceItemProps) => {
    ...
    const handleBookingClick = () => {
        if (data?.user) {
            // early return: clean code de aninhamento
    ...
    const handleCreateBooking = async () => {
        ...
        // 2. Não deixar o usuário reservar se não logado.
       try {
      ...
      <CardContent className="flex items-center gap-3 p-3">
            ...
            <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                    ...
                    {selectedDay && (
                        <div className="flex overflow-x-auto p-5 gap-4 scrollbar-hide border-b border-solid">
                      ...
                      <div className="p-5">
                        ...
                        <SheetFooter className="px-5">
                            <SheetClose asChild>
                                ...
                                ${!selectedDay || !selectedTime ? "mt-5" : ""}`}                           onClick={handleCreateBooking}
